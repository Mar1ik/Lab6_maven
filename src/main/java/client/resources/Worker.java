...
import client.resources.randomizer.IdRandomizer;
...
public class Worker implements Comparable<Worker>, Serializable {
    ...
    public Worker(String[] data) throws WrongArgEX, IdCopyEX, server.exceptions.WrongArgEX, server.exceptions.IdCopyEX {
